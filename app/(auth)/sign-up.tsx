  ...
  return (
    <ScrollView>
      <View className="flex-1 items-center justify-center bg-white p-5">
        ...
        <Text className="text-3xl font-bold text-grey-800 mb-2">
          Create Account
        </Text>
        ...
        <TouchableOpacity onPress={onSignUpPress} disabled={isLoading} className="bg-blue-500 rounded-xl py-3 px-4">
         {isLoading ? (
